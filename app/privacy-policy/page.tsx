        ...
        <main className="pt-16">
            <article className="mx-auto p-8 max-w-screen-md">
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            <strong>Application</strong> refers to meetoo, the software program provided by the Company.
                        </p>
                    </li>
                    <li>
                        <p>
                            <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to meetoo.
                        </p>
                    </li>
                    <li>
                        <p>
                ...
                <p>
                    ...
                    The information may be uploaded to the Company&apos;s servers and/or a Service Provider&apos;s
                ...
                <ul>
                    <li>By email: privacy@meetoo.app</li>
                </ul>
            </article>
        </main>
    )
